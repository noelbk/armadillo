...
extern "C"
  {
    ...
    void arma_fortran_with_prefix(arma_dgges)(char* jobvsl, char* jobvsr, char* sort, d_select_3 selctg, blas_int* n, double* a, blas_int* lda, double* b, blas_int* ldb, blas_int* sdim, double* alphar, double* alphai, double* beta, double* vsl, blas_int* ldvsl, double* vsr, blas_int* ldvsr, double* work, blas_int* lwork, blas_int* bwork, blas_int* info)
      {
    ...
    void arma_fortran_with_prefix(arma_cgges)(char* jobvsl, char* jobvsr, char* sort, c_select_2 selctg, blas_int* n, void* a, blas_int* lda, void* b, blas_int* ldb, blas_int* sdim, void* alpha, void* beta, void* vsl, blas_int* ldvsl, void* vsr, blas_int* ldvsr, void* work, blas_int* lwork,  float* rwork, blas_int* bwork, blas_int* info)
      {
    ...
    void arma_fortran_with_prefix(arma_zgges)(char* jobvsl, char* jobvsr, char* sort, z_select_2 selctg, blas_int* n, void* a, blas_int* lda, void* b, blas_int* ldb, blas_int* sdim, void* alpha, void* beta, void* vsl, blas_int* ldvsl, void* vsr, blas_int* ldvsr, void* work, blas_int* lwork, double* rwork, blas_int* bwork, blas_int* info)
      {
