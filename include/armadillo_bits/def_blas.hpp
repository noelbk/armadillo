...
extern "C"
{
  ...
  void arma_fortran(arma_cgemv)(const char* transA, const blas_int* m, const blas_int* n, const blas_cx8*  alpha, const blas_cx8*  A, const blas_int* ldA, const blas_cx8*  x, const blas_int* incx, const blas_cx8*  beta, blas_cx8*  y, const blas_int* incy, blas_len transA_len);
  void arma_fortran(arma_zgemv)(const char* transA, const blas_int* m, const blas_int* n, const blas_cx16* alpha, const blas_cx16* A, const blas_int* ldA, const blas_cx16* x, const blas_int* incx, const blas_cx16* beta, blas_cx16* y, const blas_int* incy, blas_len transA_len);
  ...
  void arma_fortran(arma_cgemm)(const char* transA, const char* transB, const blas_int* m, const blas_int* n, const blas_int* k, const blas_cx8*  alpha, const blas_cx8*  A, const blas_int* ldA, const blas_cx8*  B, const blas_int* ldB, const blas_cx8*  beta, blas_cx8*  C, const blas_int* ldC, blas_len transA_len, blas_len transB_len);
  void arma_fortran(arma_zgemm)(const char* transA, const char* transB, const blas_int* m, const blas_int* n, const blas_int* k, const blas_cx16* alpha, const blas_cx16* A, const blas_int* ldA, const blas_cx16* B, const blas_int* ldB, const blas_cx16* beta, blas_cx16* C, const blas_int* ldC, blas_len transA_len, blas_len transB_len);
  ...
  void arma_fortran(arma_cherk)(const char* uplo, const char* transA, const blas_int* n, const blas_int* k, const  float* alpha, const blas_cx8*  A, const blas_int* ldA, const  float* beta, blas_cx8*  C, const blas_int* ldC, blas_len uplo_len, blas_len transA_len);
  void arma_fortran(arma_zherk)(const char* uplo, const char* transA, const blas_int* n, const blas_int* k, const double* alpha, const blas_cx16* A, const blas_int* ldA, const double* beta, blas_cx16* C, const blas_int* ldC, blas_len uplo_len, blas_len transA_len);
  ...
  void arma_fortran(arma_cgemv)(const char* transA, const blas_int* m, const blas_int* n, const blas_cx8*  alpha, const blas_cx8*  A, const blas_int* ldA, const blas_cx8*  x, const blas_int* incx, const blas_cx8*  beta, blas_cx8*  y, const blas_int* incy);
  void arma_fortran(arma_zgemv)(const char* transA, const blas_int* m, const blas_int* n, const blas_cx16* alpha, const blas_cx16* A, const blas_int* ldA, const blas_cx16* x, const blas_int* incx, const blas_cx16* beta, blas_cx16* y, const blas_int* incy);
  ...
  void arma_fortran(arma_cgemm)(const char* transA, const char* transB, const blas_int* m, const blas_int* n, const blas_int* k, const blas_cx8*  alpha, const blas_cx8*  A, const blas_int* ldA, const blas_cx8*  B, const blas_int* ldB, const blas_cx8*  beta, blas_cx8*  C, const blas_int* ldC);
  void arma_fortran(arma_zgemm)(const char* transA, const char* transB, const blas_int* m, const blas_int* n, const blas_int* k, const blas_cx16* alpha, const blas_cx16* A, const blas_int* ldA, const blas_cx16* B, const blas_int* ldB, const blas_cx16* beta, blas_cx16* C, const blas_int* ldC);
  ...
  void arma_fortran(arma_cherk)(const char* uplo, const char* transA, const blas_int* n, const blas_int* k, const  float* alpha, const  blas_cx8*  A, const blas_int* ldA, const  float* beta, blas_cx8*  C, const blas_int* ldC);
  void arma_fortran(arma_zherk)(const char* uplo, const char* transA, const blas_int* n, const blas_int* k, const double* alpha, const  blas_cx16* A, const blas_int* ldA, const double* beta, blas_cx16* C, const blas_int* ldC);
