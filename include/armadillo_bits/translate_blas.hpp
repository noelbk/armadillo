...
namespace blas
  ...
  gemv(const char* transA, const blas_int* m, const blas_int* n, const eT* alpha, const eT* A, const blas_int* ldA, const eT* x, const blas_int* incx, const eT* beta, eT* y, const blas_int* incy)
    ...
    arma_type_check((is_supported_blas_type<eT>::value == false));
      ...
      else if( is_cx_float<eT>::value)  { typedef  blas_cx8 T; arma_fortran(arma_cgemv)(transA, m, n, (const T*)alpha, (const T*)A, ldA, (const T*)x, incx, (const T*)beta, (T*)y, incy, 1); }
      else if(is_cx_double<eT>::value)  { typedef blas_cx16 T; arma_fortran(arma_zgemv)(transA, m, n, (const T*)alpha, (const T*)A, ldA, (const T*)x, incx, (const T*)beta, (T*)y, incy, 1); }
      }
    #else
      {
      ...
      else if( is_cx_float<eT>::value)  { typedef  blas_cx8 T; arma_fortran(arma_cgemv)(transA, m, n, (const T*)alpha, (const T*)A, ldA, (const T*)x, incx, (const T*)beta, (T*)y, incy); }
      else if(is_cx_double<eT>::value)  { typedef blas_cx16 T; arma_fortran(arma_zgemv)(transA, m, n, (const T*)alpha, (const T*)A, ldA, (const T*)x, incx, (const T*)beta, (T*)y, incy); }
      }
    #endif
    }
  ...
  gemm(const char* transA, const char* transB, const blas_int* m, const blas_int* n, const blas_int* k, const eT* alpha, const eT* A, const blas_int* ldA, const eT* B, const blas_int* ldB, const eT* beta, eT* C, const blas_int* ldC)
    ...
    arma_type_check((is_supported_blas_type<eT>::value == false));
      ...
      else if( is_cx_float<eT>::value)  { typedef  blas_cx8 T; arma_fortran(arma_cgemm)(transA, transB, m, n, k, (const T*)alpha, (const T*)A, ldA, (const T*)B, ldB, (const T*)beta, (T*)C, ldC, 1, 1); }
      else if(is_cx_double<eT>::value)  { typedef blas_cx16 T; arma_fortran(arma_zgemm)(transA, transB, m, n, k, (const T*)alpha, (const T*)A, ldA, (const T*)B, ldB, (const T*)beta, (T*)C, ldC, 1, 1); }
      }
    #else
      {
      ...
      else if( is_cx_float<eT>::value)  { typedef  blas_cx8 T; arma_fortran(arma_cgemm)(transA, transB, m, n, k, (const T*)alpha, (const T*)A, ldA, (const T*)B, ldB, (const T*)beta, (T*)C, ldC); }
      else if(is_cx_double<eT>::value)  { typedef blas_cx16 T; arma_fortran(arma_zgemm)(transA, transB, m, n, k, (const T*)alpha, (const T*)A, ldA, (const T*)B, ldB, (const T*)beta, (T*)C, ldC); }
      }
    #endif
    }
  ...
  herk(const char* uplo, const char* transA, const blas_int* n, const blas_int* k, const T* alpha, const std::complex<T>* A, const blas_int* ldA, const T* beta, std::complex<T>* C, const blas_int* ldC)
    ...
    #if defined(ARMA_USE_FORTRAN_HIDDEN_ARGS)
      {
           if( is_float<T>::value)  { typedef float  TT; typedef  blas_cx8 cx_TT; arma_fortran(arma_cherk)(uplo, transA, n, k, (const TT*)alpha, (const cx_TT*)A, ldA, (const TT*)beta, (cx_TT*)C, ldC, 1, 1); }
      else if(is_double<T>::value)  { typedef double TT; typedef blas_cx16 cx_TT; arma_fortran(arma_zherk)(uplo, transA, n, k, (const TT*)alpha, (const cx_TT*)A, ldA, (const TT*)beta, (cx_TT*)C, ldC, 1, 1); }
      }
    #else
      {
           if( is_float<T>::value)  { typedef float  TT; typedef  blas_cx8 cx_TT; arma_fortran(arma_cherk)(uplo, transA, n, k, (const TT*)alpha, (const cx_TT*)A, ldA, (const TT*)beta, (cx_TT*)C, ldC); }
      else if(is_double<T>::value)  { typedef double TT; typedef blas_cx16 cx_TT; arma_fortran(arma_zherk)(uplo, transA, n, k, (const TT*)alpha, (const cx_TT*)A, ldA, (const TT*)beta, (cx_TT*)C, ldC); }
      }
    #endif
    }
