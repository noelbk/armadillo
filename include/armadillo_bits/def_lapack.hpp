...
extern "C"
{
  ...
  void arma_fortran(arma_cgetrf)(const blas_int* m, const blas_int* n,  blas_cx8* a, const blas_int* lda, blas_int* ipiv, blas_int* info);
  void arma_fortran(arma_zgetrf)(const blas_int* m, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_int* ipiv, blas_int* info);
  ...
  void arma_fortran(arma_cgetri)(const blas_int* n,  blas_cx8* a, const blas_int* lda, const blas_int* ipiv,  blas_cx8* work, const blas_int* lwork, blas_int* info);
  void arma_fortran(arma_zgetri)(const blas_int* n, blas_cx16* a, const blas_int* lda, const blas_int* ipiv, blas_cx16* work, const blas_int* lwork, blas_int* info);
  ...
  void arma_fortran(arma_ctrtri)(const char* uplo, const char* diag, const blas_int* n,  blas_cx8* a, const blas_int* lda, blas_int* info, blas_len uplo_len, blas_len diag_len);
  void arma_fortran(arma_ztrtri)(const char* uplo, const char* diag, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_int* info, blas_len uplo_len, blas_len diag_len);
  ...
  void arma_fortran(arma_cgeev)(const char* jobvl, const char* jobvr, const blas_int* N,  blas_cx8* a, const blas_int* lda,  blas_cx8* w,  blas_cx8* vl, const blas_int* ldvl,  blas_cx8* vr, const blas_int* ldvr,  blas_cx8* work, const blas_int* lwork,  float* rwork, blas_int* info, blas_len jobvl_len, blas_len jobvr_len);
  void arma_fortran(arma_zgeev)(const char* jobvl, const char* jobvr, const blas_int* N, blas_cx16* a, const blas_int* lda, blas_cx16* w, blas_cx16* vl, const blas_int* ldvl, blas_cx16* vr, const blas_int* ldvr, blas_cx16* work, const blas_int* lwork, double* rwork, blas_int* info, blas_len jobvl_len, blas_len jobvr_len);
  ...
  void arma_fortran(arma_cgeevx)(const char* balanc, const char* jobvl, const char* jobvr, const char* sense, const blas_int* n,  blas_cx8* a, const blas_int* lda,  blas_cx8* w,  blas_cx8* vl, const blas_int* ldvl,  blas_cx8* vr, const blas_int* ldvr, blas_int* ilo, blas_int* ihi,  float* scale,  float* abnrm,  float* rconde,  float* rcondv,  blas_cx8* work, const blas_int* lwork,  float* rwork, const blas_int* info, blas_len balanc_len, blas_len jobvl_len, blas_len jobvr_len, blas_len sense_len);
  void arma_fortran(arma_zgeevx)(const char* balanc, const char* jobvl, const char* jobvr, const char* sense, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_cx16* w, blas_cx16* vl, const blas_int* ldvl, blas_cx16* vr, const blas_int* ldvr, blas_int* ilo, blas_int* ihi, double* scale, double* abnrm, double* rconde, double* rcondv, blas_cx16* work, const blas_int* lwork, double* rwork, const blas_int* info, blas_len balanc_len, blas_len jobvl_len, blas_len jobvr_len, blas_len sense_len);
  ...
  void arma_fortran(arma_cheev)(const char* jobz, const char* uplo, const blas_int* n,  blas_cx8* a, const blas_int* lda,  float* w,  blas_cx8* work, const blas_int* lwork,  float* rwork, blas_int* info, blas_len jobz_len, blas_len uplo_len);
  void arma_fortran(arma_zheev)(const char* jobz, const char* uplo, const blas_int* n, blas_cx16* a, const blas_int* lda, double* w, blas_cx16* work, const blas_int* lwork, double* rwork, blas_int* info, blas_len jobz_len, blas_len uplo_len);
  ...
  void arma_fortran(arma_cheevd)(const char* jobz, const char* uplo, const blas_int* n,  blas_cx8* a, const blas_int* lda,  float* w,  blas_cx8* work, const blas_int* lwork,  float* rwork, const blas_int* lrwork, blas_int* iwork, const blas_int* liwork, blas_int* info, blas_len jobz_len, blas_len uplo_len);
  void arma_fortran(arma_zheevd)(const char* jobz, const char* uplo, const blas_int* n, blas_cx16* a, const blas_int* lda, double* w, blas_cx16* work, const blas_int* lwork, double* rwork, const blas_int* lrwork, blas_int* iwork, const blas_int* liwork, blas_int* info, blas_len jobz_len, blas_len uplo_len);
  ...
  void arma_fortran(arma_cggev)(const char* jobvl, const char* jobvr, const blas_int* n,  blas_cx8* a, const blas_int* lda,  blas_cx8* b, const blas_int* ldb,  blas_cx8* alpha,  blas_cx8* beta,  blas_cx8* vl, const blas_int* ldvl,  blas_cx8* vr, const blas_int* ldvr,  blas_cx8* work, const blas_int* lwork,  float* rwork, blas_int* info, blas_len jobvl_len, blas_len jobvr_len);
  void arma_fortran(arma_zggev)(const char* jobvl, const char* jobvr, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_cx16* b, const blas_int* ldb, blas_cx16* alpha, blas_cx16* beta, blas_cx16* vl, const blas_int* ldvl, blas_cx16* vr, const blas_int* ldvr, blas_cx16* work, const blas_int* lwork, double* rwork, blas_int* info, blas_len jobvl_len, blas_len jobvr_len);
  ...
  void arma_fortran(arma_cpotrf)(const char* uplo, const blas_int* n,  blas_cx8* a, const blas_int* lda, blas_int* info, blas_len uplo_len);
  void arma_fortran(arma_zpotrf)(const char* uplo, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_int* info, blas_len uplo_len);
  ...
  void arma_fortran(arma_cpbtrf)(const char* uplo, const blas_int* n, const blas_int* kd,  blas_cx8* ab, const blas_int* ldab, blas_int* info, blas_len uplo_len);
  void arma_fortran(arma_zpbtrf)(const char* uplo, const blas_int* n, const blas_int* kd, blas_cx16* ab, const blas_int* ldab, blas_int* info, blas_len uplo_len);
  ...
  void arma_fortran(arma_cpotri)(const char* uplo, const blas_int* n,  blas_cx8* a, const blas_int* lda, blas_int* info, blas_len uplo_len);
  void arma_fortran(arma_zpotri)(const char* uplo, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_int* info, blas_len uplo_len);
  ...
  void arma_fortran(arma_cgeqrf)(const blas_int* m, const blas_int* n,  blas_cx8* a, const blas_int* lda,  blas_cx8* tau,  blas_cx8* work, const blas_int* lwork, blas_int* info);
  void arma_fortran(arma_zgeqrf)(const blas_int* m, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_cx16* tau, blas_cx16* work, const blas_int* lwork, blas_int* info);
  ...
  void arma_fortran(arma_cungqr)(const blas_int* m, const blas_int* n, const blas_int* k,  blas_cx8* a, const blas_int* lda,   const  blas_cx8* tau,  blas_cx8* work, const blas_int* lwork, blas_int* info);
  void arma_fortran(arma_zungqr)(const blas_int* m, const blas_int* n, const blas_int* k, blas_cx16* a, const blas_int* lda,   const blas_cx16* tau, blas_cx16* work, const blas_int* lwork, blas_int* info);
  ...
  void arma_fortran(arma_cgesvd)(const char* jobu, const char* jobvt, const blas_int* m, const blas_int* n,  blas_cx8*   a, const blas_int* lda, float*  s,  blas_cx8*   u, const blas_int* ldu,  blas_cx8*   vt, const blas_int* ldvt,  blas_cx8*   work, const blas_int* lwork, float*  rwork, blas_int* info, blas_len jobu_len, blas_len jobvt_len);
  void arma_fortran(arma_zgesvd)(const char* jobu, const char* jobvt, const blas_int* m, const blas_int* n, blas_cx16*   a, const blas_int* lda, double* s, blas_cx16*   u, const blas_int* ldu, blas_cx16*   vt, const blas_int* ldvt, blas_cx16*   work, const blas_int* lwork, double* rwork, blas_int* info, blas_len jobu_len, blas_len jobvt_len);
  ...
  void arma_fortran(arma_cgesdd)(const char* jobz, const blas_int* m, const blas_int* n,  blas_cx8* a, const blas_int* lda, float*  s,  blas_cx8* u, const blas_int* ldu,  blas_cx8* vt, const blas_int* ldvt,  blas_cx8* work, const blas_int* lwork, float*  rwork, blas_int* iwork, blas_int* info, blas_len jobz_len);
  void arma_fortran(arma_zgesdd)(const char* jobz, const blas_int* m, const blas_int* n, blas_cx16* a, const blas_int* lda, double* s, blas_cx16* u, const blas_int* ldu, blas_cx16* vt, const blas_int* ldvt, blas_cx16* work, const blas_int* lwork, double* rwork, blas_int* iwork, blas_int* info, blas_len jobz_len);
  ...
  void arma_fortran(arma_cgesv)(const blas_int* n, const blas_int* nrhs,  blas_cx8* a, const blas_int* lda, blas_int* ipiv,  blas_cx8* b, const blas_int* ldb, blas_int* info);
  void arma_fortran(arma_zgesv)(const blas_int* n, const blas_int* nrhs, blas_cx16* a, const blas_int* lda, blas_int* ipiv, blas_cx16* b, const blas_int* ldb, blas_int* info);
  ...
  void arma_fortran(arma_cgesvx)(const char* fact, const char* trans, const blas_int* n, const blas_int* nrhs,  blas_cx8* a, const blas_int* lda,  blas_cx8* af, const blas_int* ldaf, blas_int* ipiv, char* equed,  float* r,  float* c,  blas_cx8* b, const blas_int* ldb,  blas_cx8* x, const blas_int* ldx,  float* rcond,  float* ferr,  float* berr,  blas_cx8* work,  float* rwork, blas_int* info, blas_len fact_len, blas_len trans_len, blas_len equed_len);
  void arma_fortran(arma_zgesvx)(const char* fact, const char* trans, const blas_int* n, const blas_int* nrhs, blas_cx16* a, const blas_int* lda, blas_cx16* af, const blas_int* ldaf, blas_int* ipiv, char* equed, double* r, double* c, blas_cx16* b, const blas_int* ldb, blas_cx16* x, const blas_int* ldx, double* rcond, double* ferr, double* berr, blas_cx16* work, double* rwork, blas_int* info, blas_len fact_len, blas_len trans_len, blas_len equed_len);
  ...
  void arma_fortran(arma_cposv)(const char* uplo, const blas_int* n, const blas_int* nrhs,  blas_cx8* a, const blas_int* lda,  blas_cx8* b, const blas_int* ldb, blas_int* info, blas_len uplo_len);
  void arma_fortran(arma_zposv)(const char* uplo, const blas_int* n, const blas_int* nrhs, blas_cx16* a, const blas_int* lda, blas_cx16* b, const blas_int* ldb, blas_int* info, blas_len uplo_len);
  ...
  void arma_fortran(arma_cposvx)(const char* fact, const char* uplo, const blas_int* n, const blas_int* nrhs,  blas_cx8* a, const blas_int* lda,  blas_cx8* af, const blas_int* ldaf, char* equed,  float* s,  blas_cx8* b, const blas_int* ldb,  blas_cx8* x, const blas_int* ldx,  float* rcond,  float* ferr,  float* berr,  blas_cx8* work,  float* rwork, blas_int* info, blas_len fact_len, blas_len uplo_len, blas_len equed_len);
  void arma_fortran(arma_zposvx)(const char* fact, const char* uplo, const blas_int* n, const blas_int* nrhs, blas_cx16* a, const blas_int* lda, blas_cx16* af, const blas_int* ldaf, char* equed, double* s, blas_cx16* b, const blas_int* ldb, blas_cx16* x, const blas_int* ldx, double* rcond, double* ferr, double* berr, blas_cx16* work, double* rwork, blas_int* info, blas_len fact_len, blas_len uplo_len, blas_len equed_len);
  ...
  void arma_fortran(arma_cgels)(const char* trans, const blas_int* m, const blas_int* n, const blas_int* nrhs,  blas_cx8* a, const blas_int* lda,  blas_cx8* b, const blas_int* ldb,  blas_cx8* work, const blas_int* lwork, blas_int* info, blas_len trans_len);
  void arma_fortran(arma_zgels)(const char* trans, const blas_int* m, const blas_int* n, const blas_int* nrhs, blas_cx16* a, const blas_int* lda, blas_cx16* b, const blas_int* ldb, blas_cx16* work, const blas_int* lwork, blas_int* info, blas_len trans_len);
  
  // approximately solve system of linear equations using svd (real)
  void arma_fortran(arma_sgelsd)(const blas_int* m, const blas_int* n, const blas_int* nrhs, const  float* a, const blas_int* lda,  float* b, const blas_int* ldb,  float* S,  const float* rcond, blas_int* rank,  float* work, const blas_int* lwork, blas_int* iwork, blas_int* info);
  void arma_fortran(arma_dgelsd)(const blas_int* m, const blas_int* n, const blas_int* nrhs, const double* a, const blas_int* lda, double* b, const blas_int* ldb, double* S, const double* rcond, blas_int* rank, double* work, const blas_int* lwork, blas_int* iwork, blas_int* info);
  
  // approximately solve system of linear equations using svd (complex)
  void arma_fortran(arma_cgelsd)(const blas_int* m, const blas_int* n, const blas_int* nrhs,        blas_cx8* a, const blas_int* lda,  blas_cx8* b, const blas_int* ldb,  float* S,  const float* rcond, blas_int* rank,  blas_cx8* work, const blas_int* lwork,  float* rwork, blas_int* iwork, blas_int* info);
  void arma_fortran(arma_zgelsd)(const blas_int* m, const blas_int* n, const blas_int* nrhs, const blas_cx16* a, const blas_int* lda, blas_cx16* b, const blas_int* ldb, double* S, const double* rcond, blas_int* rank, blas_cx16* work, const blas_int* lwork, double* rwork, blas_int* iwork, blas_int* info);
  ...
  void arma_fortran(arma_ctrtrs)(const char* uplo, const char* trans, const char* diag, const blas_int* n, const blas_int* nrhs, const  blas_cx8* a, const blas_int* lda,  blas_cx8* b, const blas_int* ldb, blas_int* info, blas_len uplo_len, blas_len trans_len, blas_len diag_len);
  void arma_fortran(arma_ztrtrs)(const char* uplo, const char* trans, const char* diag, const blas_int* n, const blas_int* nrhs, const blas_cx16* a, const blas_int* lda, blas_cx16* b, const blas_int* ldb, blas_int* info, blas_len uplo_len, blas_len trans_len, blas_len diag_len);
  ...
  void arma_fortran(arma_cgbsv)(const blas_int* n, const blas_int* kl, const blas_int* ku, const blas_int* nrhs,  blas_cx8* ab, const blas_int* ldab, blas_int* ipiv,  blas_cx8* b, const blas_int* ldb, blas_int* info);
  void arma_fortran(arma_zgbsv)(const blas_int* n, const blas_int* kl, const blas_int* ku, const blas_int* nrhs, blas_cx16* ab, const blas_int* ldab, blas_int* ipiv, blas_cx16* b, const blas_int* ldb, blas_int* info);
  ...
  void arma_fortran(arma_cgbsvx)(const char* fact, const char* trans, const blas_int* n, const blas_int* kl, const blas_int* ku, const blas_int* nrhs,  blas_cx8* ab, const blas_int* ldab,  blas_cx8* afb, const blas_int* ldafb, blas_int* ipiv, char* equed,  float* r,  float* c,  blas_cx8* b, const blas_int* ldb,  blas_cx8* x, const blas_int* ldx,  float* rcond,  float* ferr,  float* berr,  blas_cx8* work,  float* rwork, blas_int* info, blas_len fact_len, blas_len trans_len, blas_len equed_len);
  void arma_fortran(arma_zgbsvx)(const char* fact, const char* trans, const blas_int* n, const blas_int* kl, const blas_int* ku, const blas_int* nrhs, blas_cx16* ab, const blas_int* ldab, blas_cx16* afb, const blas_int* ldafb, blas_int* ipiv, char* equed, double* r, double* c, blas_cx16* b, const blas_int* ldb, blas_cx16* x, const blas_int* ldx, double* rcond, double* ferr, double* berr, blas_cx16* work, double* rwork, blas_int* info, blas_len fact_len, blas_len trans_len, blas_len equed_len);
  ...
  void arma_fortran(arma_cgtsv)(const blas_int* n, const blas_int* nrhs,  blas_cx8* dl,  blas_cx8* d,  blas_cx8* du,  blas_cx8* b, const blas_int* ldb, blas_int* info);
  void arma_fortran(arma_zgtsv)(const blas_int* n, const blas_int* nrhs, blas_cx16* dl, blas_cx16* d, blas_cx16* du, blas_cx16* b, const blas_int* ldb, blas_int* info);
  ...
  void arma_fortran(arma_cgtsvx)(const char* fact, const char* trans, const blas_int* n, const blas_int* nrhs, const  blas_cx8* dl, const  blas_cx8* d, const  blas_cx8* du,  blas_cx8* dlf,  blas_cx8* df,  blas_cx8* duf,  blas_cx8* du2, blas_int* ipiv, const  blas_cx8* b, const blas_int* ldb,  blas_cx8* x, const blas_int* ldx,  float* rcond,  float* ferr,  float* berr,  blas_cx8* work,  float* rwork, blas_int* info, blas_len fact_len, blas_len trans_len);
  void arma_fortran(arma_zgtsvx)(const char* fact, const char* trans, const blas_int* n, const blas_int* nrhs, const blas_cx16* dl, const blas_cx16* d, const blas_cx16* du, blas_cx16* dlf, blas_cx16* df, blas_cx16* duf, blas_cx16* du2, blas_int* ipiv, const blas_cx16* b, const blas_int* ldb, blas_cx16* x, const blas_int* ldx, double* rcond, double* ferr, double* berr, blas_cx16* work, double* rwork, blas_int* info, blas_len fact_len, blas_len trans_len);
  
  // Schur decomposition (real matrices)
  void arma_fortran(arma_sgees)(const char* jobvs, const char* sort, s_select_2 select, const blas_int* n, float*  a, const blas_int* lda, blas_int* sdim, float*  wr, float*  wi, float*  vs, const blas_int* ldvs, float*  work, const blas_int* lwork, blas_int* bwork, blas_int* info, blas_len jobvs_len, blas_len sort_len);
  void arma_fortran(arma_dgees)(const char* jobvs, const char* sort, d_select_2 select, const blas_int* n, double* a, const blas_int* lda, blas_int* sdim, double* wr, double* wi, double* vs, const blas_int* ldvs, double* work, const blas_int* lwork, blas_int* bwork, blas_int* info, blas_len jobvs_len, blas_len sort_len);
  
  // Schur decomposition (complex matrices)
  void arma_fortran(arma_cgees)(const char* jobvs, const char* sort, c_select_1 select, const blas_int* n,  blas_cx8* a, const blas_int* lda, blas_int* sdim,  blas_cx8* w,  blas_cx8* vs, const blas_int* ldvs,  blas_cx8* work, const blas_int* lwork, float*  rwork, blas_int* bwork, blas_int* info, blas_len jobvs_len, blas_len sort_len);
  void arma_fortran(arma_zgees)(const char* jobvs, const char* sort, z_select_1 select, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_int* sdim, blas_cx16* w, blas_cx16* vs, const blas_int* ldvs, blas_cx16* work, const blas_int* lwork, double* rwork, blas_int* bwork, blas_int* info, blas_len jobvs_len, blas_len sort_len);
  ...
  void arma_fortran(arma_ctrsyl)(const char* transa, const char* transb, const blas_int* isgn, const blas_int* m, const blas_int* n, const  blas_cx8* a, const blas_int* lda, const  blas_cx8* b, const blas_int* ldb, blas_cx8*  c, const blas_int* ldc, float*  scale, blas_int* info, blas_len transa_len, blas_len transb_len);
  void arma_fortran(arma_ztrsyl)(const char* transa, const char* transb, const blas_int* isgn, const blas_int* m, const blas_int* n, const blas_cx16* a, const blas_int* lda, const blas_cx16* b, const blas_int* ldb, blas_cx16* c, const blas_int* ldc, double* scale, blas_int* info, blas_len transa_len, blas_len transb_len);
  
  // QZ decomposition (real matrices)
  void arma_fortran(arma_sgges)(const char* jobvsl, const char* jobvsr, const char* sort, s_select_3 selctg, const blas_int* n,  float* a, const blas_int* lda,  float* b, const blas_int* ldb, blas_int* sdim,  float* alphar,  float* alphai,  float* beta,  float* vsl, const blas_int* ldvsl,  float* vsr, const blas_int* ldvsr,  float* work, const blas_int* lwork, blas_int* bwork, blas_int* info, blas_len jobvsl_len, blas_len jobvsr_len, blas_len sort_len);
  void arma_fortran(arma_dgges)(const char* jobvsl, const char* jobvsr, const char* sort, d_select_3 selctg, const blas_int* n, double* a, const blas_int* lda, double* b, const blas_int* ldb, blas_int* sdim, double* alphar, double* alphai, double* beta, double* vsl, const blas_int* ldvsl, double* vsr, const blas_int* ldvsr, double* work, const blas_int* lwork, blas_int* bwork, blas_int* info, blas_len jobvsl_len, blas_len jobvsr_len, blas_len sort_len);
  
  // QZ decomposition (complex matrices)
  void arma_fortran(arma_cgges)(const char* jobvsl, const char* jobvsr, const char* sort, c_select_2 selctg, const blas_int* n,  blas_cx8* a, const blas_int* lda,  blas_cx8* b, const blas_int* ldb, blas_int* sdim,  blas_cx8* alpha,  blas_cx8* beta,  blas_cx8* vsl, const blas_int* ldvsl,  blas_cx8* vsr, const blas_int* ldvsr,  blas_cx8* work, const blas_int* lwork,  float* rwork, blas_int* bwork, blas_int* info, blas_len jobvsl_len, blas_len jobvsr_len, blas_len sort_len);
  void arma_fortran(arma_zgges)(const char* jobvsl, const char* jobvsr, const char* sort, z_select_2 selctg, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_cx16* b, const blas_int* ldb, blas_int* sdim, blas_cx16* alpha, blas_cx16* beta, blas_cx16* vsl, const blas_int* ldvsl, blas_cx16* vsr, const blas_int* ldvsr, blas_cx16* work, const blas_int* lwork, double* rwork, blas_int* bwork, blas_int* info, blas_len jobvsl_len, blas_len jobvsr_len, blas_len sort_len);
  ...
  float  arma_fortran(arma_clange)(const char* norm, const blas_int* m, const blas_int* n, const  blas_cx8* a, const blas_int* lda,  float* work, blas_len norm_len);
  double arma_fortran(arma_zlange)(const char* norm, const blas_int* m, const blas_int* n, const blas_cx16* a, const blas_int* lda, double* work, blas_len norm_len);
  ...
  void arma_fortran(arma_cgecon)(const char* norm, const blas_int* n, const  blas_cx8* a, const blas_int* lda,  const float* anorm,  float* rcond,  blas_cx8* work,  float* rwork, blas_int* info, blas_len norm_len);
  void arma_fortran(arma_zgecon)(const char* norm, const blas_int* n, const blas_cx16* a, const blas_int* lda, const double* anorm, double* rcond, blas_cx16* work, double* rwork, blas_int* info, blas_len norm_len);
  ...
  void arma_fortran(arma_cpocon)(const char* uplo, const blas_int* n, const  blas_cx8* a, const blas_int* lda,  const float* anorm,  float* rcond,  blas_cx8* work,  float* rwork, blas_int* info, blas_len uplo_len);
  void arma_fortran(arma_zpocon)(const char* uplo, const blas_int* n, const blas_cx16* a, const blas_int* lda, const double* anorm, double* rcond, blas_cx16* work, double* rwork, blas_int* info, blas_len uplo_len);
  ...
  void arma_fortran(arma_cgehrd)(const blas_int* n, const blas_int* ilo, const blas_int* ihi,  blas_cx8* a, const blas_int* lda,  blas_cx8* tao,  blas_cx8* work, const blas_int* lwork, blas_int* info);
  void arma_fortran(arma_zgehrd)(const blas_int* n, const blas_int* ilo, const blas_int* ihi, blas_cx16* a, const blas_int* lda, blas_cx16* tao, blas_cx16* work, const blas_int* lwork, blas_int* info);
  ...
  void arma_fortran(arma_ctrtri)(const char* uplo, const char* diag, const blas_int* n,  blas_cx8* a, const blas_int* lda, blas_int* info);
  void arma_fortran(arma_ztrtri)(const char* uplo, const char* diag, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_int* info);
  ...
  // eigen decomposition of general matrix (complex)
  void arma_fortran(arma_cgeev)(const char* jobvl, const char* jobvr, const blas_int* N,  blas_cx8* a, const blas_int* lda,  blas_cx8* w,  blas_cx8* vl, const blas_int* ldvl,  blas_cx8* vr, const blas_int* ldvr,  blas_cx8* work, const blas_int* lwork,  float* rwork, blas_int* info);
  void arma_fortran(arma_zgeev)(const char* jobvl, const char* jobvr, const blas_int* N, blas_cx16* a, const blas_int* lda, blas_cx16* w, blas_cx16* vl, const blas_int* ldvl, blas_cx16* vr, const blas_int* ldvr, blas_cx16* work, const blas_int* lwork, double* rwork, blas_int* info);
  ...
  // eigen decomposition of general matrix (complex; advanced form)
  void arma_fortran(arma_cgeevx)(const char* balanc, const char* jobvl, const char* jobvr, const char* sense, const blas_int* n,  blas_cx8* a, const blas_int* lda,  blas_cx8* w,  blas_cx8* vl, const blas_int* ldvl,  blas_cx8* vr, const blas_int* ldvr, blas_int* ilo, blas_int* ihi,  float* scale,  float* abnrm,  float* rconde,  float* rcondv,  blas_cx8* work, const blas_int* lwork,  float* rwork, blas_int* info);
  void arma_fortran(arma_zgeevx)(const char* balanc, const char* jobvl, const char* jobvr, const char* sense, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_cx16* w, blas_cx16* vl, const blas_int* ldvl, blas_cx16* vr, const blas_int* ldvr, blas_int* ilo, blas_int* ihi, double* scale, double* abnrm, double* rconde, double* rcondv, blas_cx16* work, const blas_int* lwork, double* rwork, blas_int* info);
  ...
  // eigen decomposition of hermitian matrices (complex)
  void arma_fortran(arma_cheev)(const char* jobz, const char* uplo, const blas_int* n,  blas_cx8* a, const blas_int* lda,  float* w,  blas_cx8* work, const blas_int* lwork,  float* rwork, blas_int* info);
  void arma_fortran(arma_zheev)(const char* jobz, const char* uplo, const blas_int* n, blas_cx16* a, const blas_int* lda, double* w, blas_cx16* work, const blas_int* lwork, double* rwork, blas_int* info);
  ...
  // eigen decomposition of hermitian matrices (complex) by divide and conquer
  void arma_fortran(arma_cheevd)(const char* jobz, const char* uplo, const blas_int* n,  blas_cx8* a, const blas_int* lda,  float* w,  blas_cx8* work, const blas_int* lwork,  float* rwork, const blas_int* lrwork, blas_int* iwork, const blas_int* liwork, blas_int* info);
  void arma_fortran(arma_zheevd)(const char* jobz, const char* uplo, const blas_int* n, blas_cx16* a, const blas_int* lda, double* w, blas_cx16* work, const blas_int* lwork, double* rwork, const blas_int* lrwork, blas_int* iwork, const blas_int* liwork, blas_int* info);
  ...
  // eigen decomposition of general complex matrix pair
  void arma_fortran(arma_cggev)(const char* jobvl, const char* jobvr, const blas_int* n,  blas_cx8* a, const blas_int* lda,  blas_cx8* b, const blas_int* ldb,  blas_cx8* alpha,  blas_cx8* beta,  blas_cx8* vl, const blas_int* ldvl,  blas_cx8* vr, const blas_int* ldvr,  blas_cx8* work, const blas_int* lwork,  float* rwork, blas_int* info);
  void arma_fortran(arma_zggev)(const char* jobvl, const char* jobvr, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_cx16* b, const blas_int* ldb, blas_cx16* alpha, blas_cx16* beta, blas_cx16* vl, const blas_int* ldvl, blas_cx16* vr, const blas_int* ldvr, blas_cx16* work, const blas_int* lwork, double* rwork, blas_int* info);
  ...
  void arma_fortran(arma_cpotrf)(const char* uplo, const blas_int* n,  blas_cx8* a, const blas_int* lda, blas_int* info);
  void arma_fortran(arma_zpotrf)(const char* uplo, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_int* info);
  ...
  void arma_fortran(arma_cpbtrf)(const char* uplo, const blas_int* n, const blas_int* kd,  blas_cx8* ab, const blas_int* ldab, blas_int* info);
  void arma_fortran(arma_zpbtrf)(const char* uplo, const blas_int* n, const blas_int* kd, blas_cx16* ab, const blas_int* ldab, blas_int* info);
  ...
  void arma_fortran(arma_cpotri)(const char* uplo, const blas_int* n,  blas_cx8* a, const blas_int* lda, blas_int* info);
  void arma_fortran(arma_zpotri)(const char* uplo, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_int* info);
  ...
  // SVD (complex matrices)
  void arma_fortran(arma_cgesvd)(const char* jobu, const char* jobvt, const blas_int* m, const blas_int* n,  blas_cx8*   a, const blas_int* lda, float*  s,  blas_cx8*   u, const blas_int* ldu,  blas_cx8*   vt, const blas_int* ldvt,  blas_cx8*   work, const blas_int* lwork, float*  rwork, blas_int* info);
  void arma_fortran(arma_zgesvd)(const char* jobu, const char* jobvt, const blas_int* m, const blas_int* n, blas_cx16*   a, const blas_int* lda, double* s, blas_cx16*   u, const blas_int* ldu, blas_cx16*   vt, const blas_int* ldvt, blas_cx16*   work, const blas_int* lwork, double* rwork, blas_int* info);
  ...
  // SVD (complex matrices) by divide and conquer
  void arma_fortran(arma_cgesdd)(const char* jobz, const blas_int* m, const blas_int* n,  blas_cx8* a, const blas_int* lda, float*  s,  blas_cx8* u, const blas_int* ldu,  blas_cx8* vt, const blas_int* ldvt,  blas_cx8* work, const blas_int* lwork, float*  rwork, blas_int* iwork, blas_int* info);
  void arma_fortran(arma_zgesdd)(const char* jobz, const blas_int* m, const blas_int* n, blas_cx16* a, const blas_int* lda, double* s, blas_cx16* u, const blas_int* ldu, blas_cx16* vt, const blas_int* ldvt, blas_cx16* work, const blas_int* lwork, double* rwork, blas_int* iwork, blas_int* info);
  ...
  // solve system of linear equations (general square matrix, advanced form, complex matrices)
  void arma_fortran(arma_cgesvx)(const char* fact, const char* trans, const blas_int* n, const blas_int* nrhs,  blas_cx8* a, const blas_int* lda,  blas_cx8* af, const blas_int* ldaf, blas_int* ipiv, char* equed,  float* r,  float* c,  blas_cx8* b, const blas_int* ldb,  blas_cx8* x, const blas_int* ldx,  float* rcond,  float* ferr,  float* berr,  blas_cx8* work,  float* rwork, blas_int* info);
  void arma_fortran(arma_zgesvx)(const char* fact, const char* trans, const blas_int* n, const blas_int* nrhs, blas_cx16* a, const blas_int* lda, blas_cx16* af, const blas_int* ldaf, blas_int* ipiv, char* equed, double* r, double* c, blas_cx16* b, const blas_int* ldb, blas_cx16* x, const blas_int* ldx, double* rcond, double* ferr, double* berr, blas_cx16* work, double* rwork, blas_int* info);
  ...
  void arma_fortran(arma_cposv)(const char* uplo, const blas_int* n, const blas_int* nrhs,  blas_cx8* a, const blas_int* lda,  blas_cx8* b, const blas_int* ldb, blas_int* info);
  void arma_fortran(arma_zposv)(const char* uplo, const blas_int* n, const blas_int* nrhs, blas_cx16* a, const blas_int* lda, blas_cx16* b, const blas_int* ldb, blas_int* info);
  ...
  // solve system of linear equations (hermitian positive definite matrix, advanced form, complex matrices)
  void arma_fortran(arma_cposvx)(const char* fact, const char* uplo, const blas_int* n, const blas_int* nrhs,  blas_cx8* a, const blas_int* lda,  blas_cx8* af, const blas_int* ldaf, char* equed,  float* s,  blas_cx8* b, const blas_int* ldb,  blas_cx8* x, const blas_int* ldx,  float* rcond,  float* ferr,  float* berr,  blas_cx8* work,  float* rwork, blas_int* info);
  void arma_fortran(arma_zposvx)(const char* fact, const char* uplo, const blas_int* n, const blas_int* nrhs, blas_cx16* a, const blas_int* lda, blas_cx16* af, const blas_int* ldaf, char* equed, double* s, blas_cx16* b, const blas_int* ldb, blas_cx16* x, const blas_int* ldx, double* rcond, double* ferr, double* berr, blas_cx16* work, double* rwork, blas_int* info);
  ...
  void arma_fortran(arma_cgels)(const char* trans, const blas_int* m, const blas_int* n, const blas_int* nrhs,  blas_cx8* a, const blas_int* lda,  blas_cx8* b, const blas_int* ldb,  blas_cx8* work, const blas_int* lwork, blas_int* info);
  void arma_fortran(arma_zgels)(const char* trans, const blas_int* m, const blas_int* n, const blas_int* nrhs, blas_cx16* a, const blas_int* lda, blas_cx16* b, const blas_int* ldb, blas_cx16* work, const blas_int* lwork, blas_int* info);
  ...
  void arma_fortran(arma_ctrtrs)(const char* uplo, const char* trans, const char* diag, const blas_int* n, const blas_int* nrhs, const  blas_cx8* a, const blas_int* lda,  blas_cx8* b, const blas_int* ldb, blas_int* info);
  void arma_fortran(arma_ztrtrs)(const char* uplo, const char* trans, const char* diag, const blas_int* n, const blas_int* nrhs, const blas_cx16* a, const blas_int* lda, blas_cx16* b, const blas_int* ldb, blas_int* info);
  ...
  // solve system of linear equations (general band matrix, advanced form, complex matrices)
  void arma_fortran(arma_cgbsvx)(const char* fact, const char* trans, const blas_int* n, const blas_int* kl, const blas_int* ku, const blas_int* nrhs,  blas_cx8* ab, const blas_int* ldab,  blas_cx8* afb, const blas_int* ldafb, blas_int* ipiv, char* equed,  float* r,  float* c,  blas_cx8* b, const blas_int* ldb,  blas_cx8* x, const blas_int* ldx,  float* rcond,  float* ferr,  float* berr,  blas_cx8* work,  float* rwork, blas_int* info);
  void arma_fortran(arma_zgbsvx)(const char* fact, const char* trans, const blas_int* n, const blas_int* kl, const blas_int* ku, const blas_int* nrhs, blas_cx16* ab, const blas_int* ldab, blas_cx16* afb, const blas_int* ldafb, blas_int* ipiv, char* equed, double* r, double* c, blas_cx16* b, const blas_int* ldb, blas_cx16* x, const blas_int* ldx, double* rcond, double* ferr, double* berr, blas_cx16* work, double* rwork, blas_int* info);
  ...
  // solve system of linear equations (tridiagonal band matrix, advaned form, complex matrices)
  void arma_fortran(arma_cgtsvx)(const char* fact, const char* trans, const blas_int* n, const blas_int* nrhs, const  blas_cx8* dl, const  blas_cx8* d, const  blas_cx8* du,  blas_cx8* dlf,  blas_cx8* df,  blas_cx8* duf,  blas_cx8* du2, blas_int* ipiv, const  blas_cx8* b, const blas_int* ldb,  blas_cx8* x, const blas_int* ldx,  float* rcond,  float* ferr,  float* berr,  blas_cx8* work,  float* rwork, blas_int* info);
  void arma_fortran(arma_zgtsvx)(const char* fact, const char* trans, const blas_int* n, const blas_int* nrhs, const blas_cx16* dl, const blas_cx16* d, const blas_cx16* du, blas_cx16* dlf, blas_cx16* df, blas_cx16* duf, blas_cx16* du2, blas_int* ipiv, const blas_cx16* b, const blas_int* ldb, blas_cx16* x, const blas_int* ldx, double* rcond, double* ferr, double* berr, blas_cx16* work, double* rwork, blas_int* info);
  
  // Schur decomposition (real matrices)
  void arma_fortran(arma_sgees)(const char* jobvs, const char* sort, s_select_2 select, const blas_int* n, float*  a, const blas_int* lda, blas_int* sdim, float*  wr, float*  wi, float*  vs, const blas_int* ldvs, float*  work, const blas_int* lwork, blas_int* bwork, blas_int* info);
  void arma_fortran(arma_dgees)(const char* jobvs, const char* sort, d_select_2 select, const blas_int* n, double* a, const blas_int* lda, blas_int* sdim, double* wr, double* wi, double* vs, const blas_int* ldvs, double* work, const blas_int* lwork, blas_int* bwork, blas_int* info);
  
  // Schur decomposition (complex matrices)
  void arma_fortran(arma_cgees)(const char* jobvs, const char* sort, c_select_1 select, const blas_int* n,  blas_cx8* a, const blas_int* lda, blas_int* sdim,  blas_cx8* w,  blas_cx8* vs, const blas_int* ldvs,  blas_cx8* work, const blas_int* lwork, float*  rwork, blas_int* bwork, blas_int* info);
  void arma_fortran(arma_zgees)(const char* jobvs, const char* sort, z_select_1 select, const blas_int* n, blas_cx16* a, const blas_int* lda, blas_int* sdim, blas_cx16* w, blas_cx16* vs, const blas_int* ldvs, blas_cx16* work, const blas_int* lwork, double* rwork, blas_int* bwork, blas_int* info);
  ...
  void arma_fortran(arma_ctrsyl)(const char* transa, const char* transb, const blas_int* isgn, const blas_int* m, const blas_int* n, const  blas_cx8* a, const blas_int* lda, const  blas_cx8* b, const blas_int* ldb,  blas_cx8* c, const blas_int* ldc, float*  scale, blas_int* info);
  void arma_fortran(arma_ztrsyl)(const char* transa, const char* transb, const blas_int* isgn, const blas_int* m, const blas_int* n, const blas_cx16* a, const blas_int* lda, const blas_cx16* b, const blas_int* ldb, blas_cx16* c, const blas_int* ldc, double* scale, blas_int* info);
  
  // QZ decomposition (real matrices)
  void arma_fortran(arma_sgges)(const char* jobvsl, const char* jobvsr, const char* sort, s_select_3 selctg, const blas_int* n,  float* a, const blas_int* lda,  float* b, const blas_int* ldb, blas_int* sdim,  float* alphar,  float* alphai,  float* beta,  float* vsl, const blas_int* ldvsl,  float* vsr, const blas_int* ldvsr,  float* work, const blas_int* lwork, blas_int* bwork, blas_int* info);
  void arma_fortran(arma_dgges)(const char* jobvsl, const char* jobvsr, const char* sort, d_select_3 selctg, const blas_int* n, double* a, const blas_int* lda, double* b, const blas_int* ldb, blas_int* sdim, double* alphar, double* alphai, double* beta, double* vsl, const blas_int* ldvsl, double* vsr, const blas_int* ldvsr, double* work, const blas_int* lwork, blas_int* bwork, blas_int* info);
  
  // QZ decomposition (complex matrices)
  void arma_fortran(arma_cgges)(const char* jobvsl, const char* jobvsr, const char* sort, c_select_2 selctg, const blas_int* n,  blas_cx8* a, const blas_int* lda,  blas_cx8* b, const blas_int* ldb, blas_int* sdim,  blas_cx8* alpha,  blas_cx8* beta,  blas_cx8* vsl, const blas_int* ldvsl,  blas_cx8* vsr, const blas_int* ldvsr,  blas_cx8* work, const blas_int* lwork,  float* rwork, blas_int* bwork, blas_int* info);
  ...
  float  arma_fortran(arma_clange)(const char* norm, const blas_int* m, const blas_int* n, const  blas_cx8* a, const blas_int* lda,  float* work);
  double arma_fortran(arma_zlange)(const char* norm, const blas_int* m, const blas_int* n, const blas_cx16* a, const blas_int* lda, double* work);
  ...
  // reciprocal of condition number (complex, generic matrix)
  void arma_fortran(arma_cgecon)(const char* norm, const blas_int* n, const  blas_cx8* a, const blas_int* lda,  const float* anorm,  float* rcond,  blas_cx8* work,  float* rwork, blas_int* info);
  void arma_fortran(arma_zgecon)(const char* norm, const blas_int* n, const blas_cx16* a, const blas_int* lda, const double* anorm, double* rcond, blas_cx16* work, double* rwork, blas_int* info);
  ...
  // reciprocal of condition number (complex, hermitian positive definite matrix)
  void arma_fortran(arma_cpocon)(const char* uplo, const blas_int* n, const  blas_cx8* a, const blas_int* lda,  const float* anorm,  float* rcond,  blas_cx8* work,  float* rwork, blas_int* info);
  void arma_fortran(arma_zpocon)(const char* uplo, const blas_int* n, const blas_cx16* a, const blas_int* lda, const double* anorm, double* rcond, blas_cx16* work, double* rwork, blas_int* info);
